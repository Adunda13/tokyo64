...
<Container className="containerPadding">
  ...
  <div className="row">
    <div className="col">
    <img src={meInYokohama} className="rounded thumbnailShot" alt="me in Yokohama"/>
  ...
  <div className="row">
    ...
    <div className="col">
    <img src={osakaGlico} className="rounded thumbnailShot" alt="Osaka minami"/>
    </div>
  ...
  <div className="row">
  <div className="col">
    <img src={teachNova} className="rounded thumbnailShot" alt="Teach at Nova"/>
    </div>
  	<div className="col-7">
